! function (t, e) {
    ...
    var h, d = g.fn.button,
        f = ((h = p.prototype).toggle = function () {
            var t, e, n = !0,
                i = !0,
    ...
    var _, v = "carousel",
        ...
        T = ((_ = C.prototype).next = function () {
            ...
            if (!(t > this._items.length - 1 || t < 0))
                if (this._isSliding) g(this._element).one("slid.bs.carousel", function () {
                    return e.to(t)
                });
                else {
            ...
            return this.each(function () {
                ...
                if (t || (t = new C(this, e), g(this).data("bs.carousel", t)), "number" == typeof i) t.to(i);
    ...
    var S, D = "collapse",
        ...
        I = ((S = O.prototype).toggle = function () {
    ...
    var j, P = "dropdown",
        ...
        F = ((j = Q.prototype).toggle = function () {
            ...
            this._element.disabled || g(this._element).hasClass("disabled") || !g(this._menu).hasClass("show") || (t = {
                relatedTarget: this._element
            }, e = g.Event("hide.bs.dropdown", t), n = Q._getParentFromElement(this._element), g(n).trigger(e), e.isDefaultPrevented() || (this._popper && this._popper.destroy(), g(this._menu).toggleClass("show"), g(n).toggleClass("show").trigger(g.Event("hidden.bs.dropdown", t))))
        }, j.dispose = function () {
            ...
            if (!t || 3 !== t.which && ("keyup" !== t.type || 9 === t.which))
                for (var e = [].slice.call(document.querySelectorAll('[data-toggle="dropdown"]')), n = 0, i = e.length; n < i; n++) {
                    var o, s, r = Q._getParentFromElement(e[n]),
    ...
    var B, H = g.fn.modal,
        ...
        W = ((B = V.prototype).toggle = function (t) {
            ...
            var e, n = this;
            this._isShown || this._isTransitioning || (g(this._element).hasClass("fade") && (this._isTransitioning = !0), e = g.Event("show.bs.modal", {
                relatedTarget: t
            }), g(this._element).trigger(e), this._isShown || e.isDefaultPrevented() || (this._isShown = !0, this._checkScrollbar(), this._setScrollbar(), this._adjustDialog(), this._setEscapeEvent(), this._setResizeEvent(), g(this._element).on("click.dismiss.bs.modal", '[data-dismiss="modal"]', function (t) {
                return n.hide(t)
            ...
            var s, r = g.Event("shown.bs.modal", {
                relatedTarget: t
            });
    ...
    var gt, mt = "scrollspy",
        ...
        bt = ((gt = yt.prototype).refresh = function () {
            ...
            n.hasClass("dropdown-item") ? (n.closest(".dropdown").find(".dropdown-toggle").addClass("active"), n.addClass("active")) : (n.addClass("active"), n.parents(".nav, .list-group").prev(".nav-link, .list-group-item").addClass("active"), n.parents(".nav, .list-group").prev(".nav-item").children(".nav-link").addClass("active")), g(this._scrollElement).trigger("activate.bs.scrollspy", {
                relatedTarget: e
            })
        }, gt._clear = function () {
    ...
    var St, Dt = g.fn.toast,
        ...
        At = ((St = It.prototype).show = function () {
            var t, e, n = this,
    ...
    }, t.Alert = l, t.Button = f, t.Carousel = T, t.Collapse = I, t.Dropdown = F, t.Modal = W, t.Popover = ft, t.Scrollspy = bt, t.Tab = Tt, t.Toast = At, t.Tooltip = st, t.Util = m, Object.defineProperty(t, "__esModule", {
        value: !0
    })
});