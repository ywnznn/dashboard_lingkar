              ...
              <ul class="navbar-nav flex-fill w-100 mb-2">
                ...
                <li class="nav-item dropdown"><a href="#contact" data-toggle="collapse" aria-expanded="false"
                  ...
                  <ul class="collapse list-unstyled pl-4 w-100" id="contact"><a class="nav-link pl-3"
                      href="./income_harian.php"><span class="ml-1">Penghasilan Perhari</span></a><a
                      class="nav-link pl-3" href="./income_bulanan.php"><span class="ml-1">Report </span></a></ul>
                </li>
            ...
            <div class="row justify-content-center">
              <div class="col-12 col-lg-10 col-xl-8">
                ...
                <div class="my-4">
                  ...
                  </ul><button type="button" class="btn mb-2 btn-primary center-block" data-toggle="modal"
                  ...
                  <form>
                    <div class="row mt-5 align-items-center">
                      <div class="col-md-3 text-center mb-5">
                        <div class="avatar avatar-xl"><img src="./foto/user/<?php echo $ssfoto?>" class="avatar"
                            alt="Avatar">
                          <style>
                            .avatar {
                              width: 170px;
                      ...
                      <div class="col">
                        <div class="row align-items-center">
                          <div class="col-md-7">
                            ...
                            <h6><?php echo $sskecamatan?>,
                              &nbsp;
                              <?php echo $sskota?>&nbsp;
                              <?php echo $ssprovinsi?></h6>
                          </div>
                        </div>
                        <div class="row mb-4">
                          <div class="col-md-7">
                      ...
                      <div class="row">
                        <div class="col-md-8">
                          <div class="form-group"><label for="example-text-input" class="form-control-label">Nama
                              Lengkap</label><input class="form-control" type="text" value="<?php echo $ssfullname?>"
                              disabled></div>
                        </div>
                      </div>
                      <div class="row">
                      ...
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group"><label for="example-text-input"
                              ...
                              value="<?php echo $sskota ?>" disabled></div>
                        </div>
                        <div class="col-md-6">
                          <div class="form-group"><label for="example-text-input"
                              class="form-control-label">provinsi</label><input class="form-control" type="text"
                              value="<?php echo $ssprovinsi ?>" disabled></div>
                        </div>
                      </div>
                      <div class="mb-3"><label for="exampleFormControlTextarea1"
                          class="form-label">Alamat</label><textarea class="form-control"
                          id="exampleFormControlTextarea1" rows="3" name="txt_alamat"
                          disabled><?php echo $ssalamat ?></textarea></div>
                </div>
              </div>
              < !-- Pop up Add User -->
                < !-- <button type="button" class="btn mb-2 btn-primary" data-toggle="modal"
                  data-target=".bd-example-modal-xl">Add User</button>--><div class="modal fade bd-example-modal-xl"
                    ...
                    <div class="modal-dialog modal-xl" role="document">
                      <div class="modal-content"><br>
                        ...
                        </center><button type="button" class="close" data-dismiss="modal" aria-label="Close"></button>
                        <div class="modal-footer"></div>
                        <div class="row">
                          <form action="profil.php" method="post" enctype="multipart/form-data">
                            <div class="col-md-6">
                              <div class="form-group"><label for="example-text-input" class="form-control-label">Nama
                                  Lengkap</label><input class="form-control" type="text"
                                  value="<?php echo $ssfullname?>" name="edit_namalengkap" required></div>
                            </div>
                            <div class="col-md-6">
                              <div class="form-group"><label for="example-text-input"
                                  class="form-control-label">Username</label><input class="form-control" type="text"
                                  value="<?php echo $ssuser?>" name="edit_username"></div>
                            </div>
                        </div>
                        <div class="row">
                          <div class="col-md-6">
                            <div class="form-group"><label for="example-text-input"
                                class="form-control-label">Email</label><input class="form-control" type="text"
                                value="<?php echo $ssemail?>" name="edit_email"></div>
                          </div>
                          <div class="col-md-6">
                            <div class="form-group"><label for="example-text-input"
                                class="form-control-label">Password</label><input class="form-control" type="password"
                                value="<?php echo $sspassword?>" name="edit_password"></div>
                          </div>
                          <div class="col-md-6">
                            <div class="form-group mb-3"><label for="customFile">Photo</label>
                              <div class="custom-file"><input type="file" class="custom-file-input" id="customFile"
                                  name="edit_foto"><label class="custom-file-label" for="customFile">Choose file</label>
                              </div>
                            </div>
                          </div>
                          <div class="col-md-6">
                            <div class="form-group"><label for="example-text-input" class="form-control-label">No
                                HP</label><input class="form-control" type="text" value="<?php echo $ssnohp?>"
                                name="edit_nohp"></div>
                          </div>
                        </div>
                        <div class="form-group"><label for="inputState5">Kecamatan</label><select id="inputState5"
                            class="form-control" name="edit_kecamatan">
                            <option selected=""><?php echo $sskecamatan?></option>
                            <option>Ajung</option>
                            <option>Ambulu</option>
                            <option>Arjasa</option>
                        ...
                        <div class="row">
                          <div class="col-md-6">
                            <div class="form-group"><label for="example-text-input"
                                class="form-control-label">Kota</label><input class="form-control" type="text"
                                value="<?php echo $sskota?>" name="edit_kota" disabled></div>
                          </div>
                          <div class="col-md-6">
                            <div class="form-group"><label for="example-text-input"
                                class="form-control-label">provinsi</label><input class="form-control" type="text"
                                value="<?php echo $ssprovinsi?>" name="edit_provinsi" disabled></div>
                          </div>
                        </div>
                        <div class="mb-3"><label for="exampleFormControlTextarea1"
                            class="form-label">Alamat</label><textarea class="form-control"
                            id="exampleFormControlTextarea1" rows="3"
                            name="edit_alamat"><?php echo $ssalamat?></textarea></div>
                        <div class="modal-footer"><button type="button" class="btn mb-2 btn-secondary"
                            data-dismiss="modal">Close</button><button class="btn mb-2 btn-primary" type="submit"
                            name="submit">Ubah</button></div>
                      </div>
                    </div>
                  </div>
                </form>
